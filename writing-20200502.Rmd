...
```{marginfigure}
 Yes, all of them. That one, too. It’s problematic as hell.
```
...
```
: the right to ignorance? And if so, how extensive are those rights at the moment?  
