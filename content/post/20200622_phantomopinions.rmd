...
All that said, I still consider that referring to fallacies by name is an intellectual danger zone. So if by any remote chance you make use of this term elsewhere, *please also explain what the actual problem is*. Inventing the term made the problem more legible for me, but using fallacy terms rather than full explanations can make us less legible to other people, and if we want to argue well, that is something to avoid wherever we can.
