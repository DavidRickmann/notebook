...
* The fact that nice crisp stationary is a trigger for this is really specific, and it’s weird. I’m not sure I want you to know [how weird I am](/2020/05/07/revolutionary-road-how-not-to-be-interesting/).
...
But when I wrote the piece, I found that even though the inspiration behind it was weirdly specific and personal, the actual post was not. I’m fairly sure that no-one who read it will have my particular, stationary-based problem.  {{% marginnote %}} If I’m wrong about this: what *should* I write soothing lists of? Answers on a neatly written postcard. {{% /marginnote %}} But it turns out that was merely a framing to explore the more general problem of, in [David’s](https://twitter.com/DRMacIver/status/1269192874010255360) words, “the tendency for achievable, bounded, goals you want to morph into unachievable, unbounded, ones you want to want, out of a sense of completeness”.
