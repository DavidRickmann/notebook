...
refs:
   - "Jean-Paul Sartre"
description: "Is seeking immortality evil?"
---
...
* Seeking immortality, or wanting to prolong your life indefinitely, is the mark of a Villian. (Essentially because it is a sign of considering yourself important, much as [recognising yourself as beautiful](/2020/05/01/beauty-and-identity/) might be.) {{% marginnote %}} ![Raston Robot Warrior](/img/SilverDancer.png) {{% /marginnote %}}



* Preserving your life in the face of any given immediate threat, however, is not villainous in the least. All the characters do this. Otherwise they would not escape the Daleks and the Cybermen and the Yeti and the weird silver dancer and so on. {{% marginnote %}}(weird silver dancer){{% /marginnote %}}        
