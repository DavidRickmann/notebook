...
1.  It requires you to identify every potential explanation for the observed phenomenon,
    
2.  It requires you to demonstrate that all but one of those is impossible,
    
3.  It claims that we are more justified in believing highly improbable statements than impossible ones.
